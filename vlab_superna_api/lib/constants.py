...
DEFINED = OrderedDict([
            ('VLAB_SUPERNA_LOG_LEVEL', environ.get('VLAB_SUPERNA_LOG_LEVEL', 'INFO')),
            ...
            ('VLAB_MESSAGE_BROKER', environ.get('VLAB_MESSAGE_BROKER', 'superna-broker')),
            ('VLAB_URL', environ.get('VLAB_URL', 'https://localhost')),
            ('VLAB_SUPERNA_IMAGES_DIR', environ.get('VLAB_SUPERNA_IMAGES_DIR', '/images')),
